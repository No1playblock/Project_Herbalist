...
namespace Herbalist.Editor
{
    public static class PlayScreenSetup
    {
        public static string Apply()
        {
            ...
            var reference = AssetDatabase.LoadAssetAtPath<InputActionReference>(folder + "ToggleScreen.asset");
            if (reference == null) { reference = InputActionReference.Create(action); AssetDatabase.CreateAsset(reference, folder + "ToggleScreen.asset"); }
            string path = folder + "PlayerMovementPrototype.unity";
