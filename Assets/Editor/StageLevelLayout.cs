...
namespace Herbalist.Editor
{
    ...
    {
        public const string One="Assets/StageOne/StageOnePrototype.unity";
        public const string Two="Assets/StageTwo/StageTwoPrototype.unity";
        ...
        public static string Build(bool resumeUnmodifiedCopy = false)
        {
            ...
            if(!AssetDatabase.IsValidFolder("Assets/StageTwo"))AssetDatabase.CreateFolder("Assets","StageTwo");if(AssetDatabase.LoadAssetAtPath<SceneAsset>(Two)==null)AssetDatabase.CopyAsset(One,Two);
        ...
        public static string FinishInterior()
        {
            ...
            stone=AssetDatabase.LoadAssetAtPath<Material>("Assets/StageTwo/PathStone.mat");
        ...
        private static Material Material(string name,Color color){var path="Assets/StageTwo/"+name+".mat";var m=AssetDatabase.LoadAssetAtPath<Material>(path);if(m!=null)return m;m=new Material(Shader.Find("Universal Render Pipeline/Lit"));m.color=color;AssetDatabase.CreateAsset(m,path);return m;}
