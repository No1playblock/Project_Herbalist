...
namespace Herbalist.Editor
{
    ...
    {
        public const string Main = "Assets/Scenes/MainMenu.unity";
        private const string Root = "Assets/Lobby";
        ...
        public static string Build()
        {
            ...
            if (!AssetDatabase.IsValidFolder(Root)) AssetDatabase.CreateFolder("Assets", "Lobby");
            ...
            settings.playScenePath = "Assets/PlayerPrototype/PlayerMovementPrototype.unity";
            AssetDatabase.CreateAsset(settings, Root + "/LobbySettings.asset");
            ...
            var prefab = PrefabUtility.SaveAsPrefabAsset(transport, Root + "/FusionRunner.prefab");
